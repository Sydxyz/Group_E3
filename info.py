...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/gettglinks')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ? I ᴀᴍ Sᴏ Cᴜᴛᴇ Hᴜʜ😁?')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001747230379')).split()]
